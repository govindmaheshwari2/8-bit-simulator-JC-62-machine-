...
butt5.bind("<Button-1>", ControlSignals)
butt7.bind("<Button-1>", Run)
...
butt5.place(x=180, y=640, relwidth=0.8, relheight=1, height=-670, width=-300)
butt7.place(x=360, y=600, relwidth=0.8, relheight=1, height=-670, width=-300)
...
lframe9.place(x=150, y=230, relwidth=0.9, relheight=0.1, height=-5, width=-160)
PC.pack()
ACC.pack()
B.pack()
MAR.pack()
...
entry.place(x=156, y=250, relwidth=0.5, relheight=0.06, height=-4, width=-160)
...
helpmenu.add_command(label="Sample Codes", command=Samples)
menubar.add_cascade(label="Help", menu=helpmenu)
root.config(menu=menubar)
#filemenu.add_command(label="Open", command=donothing)
#filemenu.add_command(label="Save as...", command=donothing)
#img=PIL.Image.PhotoImage(image= PIL.Image.fromarray(cv_img))
